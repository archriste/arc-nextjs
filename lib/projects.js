const frontEndProjectsData = [
        ...
        },
        {
            ...
            description: 'A markdown previewer with input and output windows that can be maximized for easier viewing. Includes a brief tutorial on markdown.',
    ...
    const visualizationProjectsData = [
        ...
        },
        {
            ...
            description: 'A bar chart of the United States GDP each quarter from 1947 to 2015. Mouse over each bar to see the exact GDP value!',
