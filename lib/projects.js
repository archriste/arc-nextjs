const frontEndProjectsData = [
    ...
    const visualizationProjectsData = [
        ...
        },
        {
            ...
            description: 'A heat map of the monthly global land-surface temperature from 1753 to 2015. The color of each data value is generated continuously with a gradient.',
        ...
        },
        {
            ...
            description: 'A scatterplot graph of the 35 fastest times up Alpe d\'Huez (a famous hillclimb) in the Tour de France and the doping allegations surrounding them.',
